...
@echo on
batchisp -device atmega16u2 -hardware usb -operation erase f memory flash blankcheck loadbuffer "Arduino-keyboard-0.3.hex" program verify start reset 1024
@echo off
if %errorlevel% NEQ 0 (
    echo %errorlevel%
...
echo but it will show up as a keyboard! Press any key to exit....
goto EXIT
